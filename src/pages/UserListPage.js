...
const UserListPage = () => {
  ...
  const {
    ...
    userListPaginatiton: paginatedUsers,
    userListLoading,
    userListError,
    listUsers,
    loginUser,
  ...
  return (
    <div className="min-h-screen bg-tertiary-50">
      <div className="section-center py-12  flex-col  ">
        {userListLoading || deleteUserLoading ? (
          <Loading />
        ) : userListError || deleteUserError ? (
          <Error title={userListError ? userListError : deleteUserError} />
        ) : (
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-200 uppercase border-b border-gray-00">
                      ...
                      <th className="px-0 py-3 text-xs md:text-sm lg:text-base text-center"></th>
                    </tr>
                  </thead>
                    ...
                    {usersPerPage?.map((user, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* DETAILS */}
                          <td className="py-3 border px-0 flex flex-col  sm:flex-row sm:items-end sm:justify-between bg-amber-50">
                            {/* Edit btn */}
                            <Link
                              to={`/admin/user/${id}/edit`}
                            >
                              <button className="w-full flex justify-center px-2 py-1 rounded mb-1 sm:mb-0">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  className="h-4 w-4 sm:w-5 sm:h-5 md:h-6 md:w-6  text-secondary-600 hover:text-secondary-900 hover:scale-110 "
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                                >
                            ...
                            <button
                              ...
                              className="w-full flex justify-center px-2 py-1 rounded "
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-4 w-4 sm:w-5 sm:h-5 md:h-6 md:w-6 text-red-400 hover:text-red-600 hover:scale-110 "
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
